...
load("./experiment_2/workspaces/Looking_times.RData")
```
...
after_agent_dir_cue.data <-
  read_delim(
    "experiment_2/data/Woodward2022_IA_Report_for_combined-agent-object_analysis_IP_after_agent_directional_cue.txt",
    na = ".",
    delim = "\t"
  ) %>%
  dplyr::select(
