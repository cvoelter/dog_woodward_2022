...
```
##Equivalence tests: two one-sided tests
```{r}
#Cannnon & Woodward (2012)'s Cohen's d= (0.65-0.29)/sqrt((0.28^2+0.33^2)/2) =1.18
library(TOSTER)
TOSTtwo(m1 = 0.08, m2 = 0.21, sd1 = 0.27, sd2 = 0.41, n1 = 19, n2 = 19, low_eqbound_d = -1.18, high_eqbound_d = 1.18, alpha = 0.05, var.equal = FALSE)
```
