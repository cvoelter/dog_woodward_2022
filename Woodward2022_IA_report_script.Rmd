...
#IA_fam_object=what does the AOI looked at contain
...
first4s.data.wider<-first4s.data%>%
  select(subject, session.num, condition_trial, Trial_Index_, IA_LABEL,  IA_fam_object, condition, trial_type, agent_target_side_first, condition_first, video_file,  DATA_FILE, IA_AREA, IA_DWELL_TIME, IA_FIXATION_COUNT)%>% #probably some time variable missing?
