...
first remove data before agent starts moving and before they looked at the agent
```{r}
...
ggplot(sample.data.ft.al.agg2, aes(x=IA_fam_object, y = mean_first_object_look)) +
