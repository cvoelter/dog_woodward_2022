...
```
Idea: find the first fixation to object after first fixation at agent and after agent started moving (at around 1600). Approach: delete sample before the agent was looked at and before agent started moving. 
```{r}
...
#   label= c("ns","*"),
#   obj=c("Distractor", "Target"),
#   x=c(1.5, 1.5),
#   y=c(4850,4850))
# fam_gat_dt2<-fam_gat_dt2 + geom_text(
#   data    = annot.data,
#   mapping = aes(x = x, y = y, label = label)
# )

lines<-tibble(
  metric=c("Distractor", "Target"),
  x= c(1,1),
  xend = c(2,2) ,
  y = c(4950, 4800),
  yend = y
...
##LL: Shouldn't a p-value adjustment be performed here for multiple testing?
