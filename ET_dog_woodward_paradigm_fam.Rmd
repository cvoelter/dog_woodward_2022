...
#LL:agent start time should be deleted from all occurrences in this script
...
```{r}
sample.data<-read.delim("data/dog_woodward_paradigm_sample_report_with_agents_AOIs.txt")
