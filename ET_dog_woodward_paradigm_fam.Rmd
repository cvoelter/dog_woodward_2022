...
###LL: These videos are not perfectly synchronised: the claw visually overlaps with the objects sooner than the hand. But the hand makes contact with the object sooner. The claw reaching up is faster than the calw reaching down etc. I chose video frame 39 as in all conditions the agent already visually overlaps with the object but the action is not completed yet. An alternative could be frame 30 which is very conservative for the claw down.
