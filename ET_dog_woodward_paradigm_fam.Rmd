...
#load("./workspaces/ET_dog_woodward_kano_paradigm_familiarisation_SLOW.RData")
...
#SLOW algorithm: sample.data<-read_parquet("data/dog_woodward_paradigm_Sample_Report_SLOW.parquet")
