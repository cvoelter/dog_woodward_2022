...
```{r}
model_table_dwell_time<- bind_cols(as.data.frame(summary(mm1.latency)$coefficients),
                             boot.full.mm1.latency$ci.estimates[1:4,],
                             drop1_mm1.latency) %>% #continue from here: replace drop1 with lmertest output
